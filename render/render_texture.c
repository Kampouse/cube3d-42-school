...
/*   Updated: 2022/06/05 15:31:21 by anthony          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	render_texture(t_game *game, int i, double hauteur)
{
	...
	if (game->ray->last_hit == 'x')
		asset_width = (((int)game->ray->pos_rayy % game->player->scale) * img->width) / game->player->scale;
	if (game->ray->last_hit == 'y')
		asset_width = (((int)game->ray->pos_rayx % game->player->scale) * img->width) / game->player->scale;
